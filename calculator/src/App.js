          ...
          <div className="mt-4">
            {activeTab === 0 ? (
              ...
              <div>
                ...
                <div className="mt-4 bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium mb-2">融资计划</h3>
                  <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-300">
                      <thead>
                        <tr className="bg-gray-100">
                          <th className="px-4 py-2 border">季度</th>
                          <th className="px-4 py-2 border">金额</th>
                          ...
                          <tr key={index}>
                            ...
                            <td className="px-4 py-2 border">
                              <input 
                                ...
                                className="w-full p-1 border rounded"
                                onChange={(e) => {
                                  const newFinancing = [...parameters.financing];
                                  newFinancing[index].amount = parseFloat(e.target.value);
                                  setParameters({...parameters, financing: newFinancing});
                                }}
                              />
                            </td>
                            <td className="px-4 py-2 border">
                              <input 
                                ...
                                onChange={(e) => {
                                  const newFinancing = [...parameters.financing];
                                  newFinancing[index].note = e.target.value;
                                  setParameters({...parameters, financing: newFinancing});
                                }}
                              />
                            </td>
                ...
                <div className="mt-4 bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium mb-2">成本配置</h3>
                  
                  <div className="mb-4">
                    <h4 className="text-sm font-medium">成本类别选择</h4>
                      ...
                      {parameters.costCategories.map((category, index) => (
                        <div key={index} className="flex items-center">
                          <input 
                            ...
                            onChange={(e) => {
                              const newCategories = [...parameters.costCategories];
                              newCategories[index].isActive = e.target.checked;
                              setParameters({...parameters, costCategories: newCategories});
                            }}
                            className="mr-2"
                          />
                          <label htmlFor={`category-${index}`} className="text-sm">{category.name}</label>
                        </div>
                      ))}
                    </div>
                  </div>
